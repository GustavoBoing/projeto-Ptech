...
export const Pokemon = () => {
    ...
    /*let levelPokemon = "Iniciante";
    if(pokemon.level === 2){
        levelPokemon = "Intermediário";
    }
    ...
    <section className="preview__container">
            ...
            <div className="preview__details">
                ...
                <div className="preview__pills">
                  {
                    pokemon.stats_battle.map((item: any)  =>
                    {
        ...
        </section><section className="skills__container">
            ...
            {
                Boolean(pokemon.evolutions.length) && //!! ou Boolean tem o mesmo propósito, quer dizer que vc está convertender aquilo para boolean->
